...
public partial class _NULL_CONTEXT_MULTIPLE : AXSharp.Connector.ITwinObject, IContext_Multiple, IObject_Multiple
{
    ...
    public async Task<global::Pocos._NULL_CONTEXT_MULTIPLE> OnlineToPlainAsync(eAccessPriority priority = eAccessPriority.Normal)
    {
    ...
    public async Task<IEnumerable<ITwinPrimitive>> PlainToOnlineAsync(global::Pocos._NULL_CONTEXT_MULTIPLE plain, eAccessPriority priority = eAccessPriority.Normal)
    {
