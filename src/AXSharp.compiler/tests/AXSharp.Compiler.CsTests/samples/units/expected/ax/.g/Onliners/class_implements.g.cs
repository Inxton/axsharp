...
public partial class _NULL_CONTEXT : AXSharp.Connector.ITwinObject, IContext
{
    ...
    public async Task<global::Pocos._NULL_CONTEXT> OnlineToPlainAsync(eAccessPriority priority = eAccessPriority.Normal)
    {
    ...
    public async Task<IEnumerable<ITwinPrimitive>> PlainToOnlineAsync(global::Pocos._NULL_CONTEXT plain, eAccessPriority priority = eAccessPriority.Normal)
    {
