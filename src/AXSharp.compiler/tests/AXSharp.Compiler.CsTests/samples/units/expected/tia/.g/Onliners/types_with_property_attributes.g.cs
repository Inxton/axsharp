...
namespace TypesWithPropertyAttributes
{
    public partial class SomeAddedProperties : AXSharp.Connector.ITwinObject
    {
        ...
        public async Task<global::Pocos.TypesWithPropertyAttributes.SomeAddedProperties> OnlineToPlainAsync(eAccessPriority priority = eAccessPriority.Normal)
        {
        ...
        public async Task<IEnumerable<ITwinPrimitive>> PlainToOnlineAsync(global::Pocos.TypesWithPropertyAttributes.SomeAddedProperties plain, eAccessPriority priority = eAccessPriority.Normal)
        {
