...
namespace lib2
{
    public partial class MyClass : AXSharp.Connector.ITwinObject
    {
        ...
        public async Task<global::Pocos.lib2.MyClass> _OnlineToPlainNoacAsync()
        {
            global::Pocos.lib2.MyClass plain = new global::Pocos.lib2.MyClass();
            plain.MyString = MyString.LastValue;
            plain.MyInt = MyInt.LastValue;
        ...
        [Obsolete("This method should not be used if you indent to access the controllers data. Use `OnlineToPlain` instead.")]
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        protected async Task<global::Pocos.lib2.MyClass> _OnlineToPlainNoacAsync(global::Pocos.lib2.MyClass plain)
        {
            plain.MyString = MyString.LastValue;
            plain.MyInt = MyInt.LastValue;
            return plain;
...
#pragma warning restore CS0612
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        public async Task _PlainToOnlineNoacAsync(global::Pocos.lib2.MyClass plain)
        {
#pragma warning disable CS0612
            MyString.LethargicWrite(plain.MyString);
#pragma warning restore CS0612
...
#pragma warning restore CS0612
        ...
        public async Task<global::Pocos.lib2.MyClass> ShadowToPlainAsync()
        {
            global::Pocos.lib2.MyClass plain = new global::Pocos.lib2.MyClass();
        ...
        protected async Task<global::Pocos.lib2.MyClass> ShadowToPlainAsync(global::Pocos.lib2.MyClass plain)
        {
            plain.MyString = MyString.Shadow;
            plain.MyInt = MyInt.Shadow;
            return plain;
        ...
        public async Task<IEnumerable<ITwinPrimitive>> PlainToShadowAsync(global::Pocos.lib2.MyClass plain)
        {
        ...
        ///</summary>
        public async Task<bool> DetectsAnyChangeAsync(global::Pocos.lib2.MyClass plain, global::Pocos.lib2.MyClass latest = null)
        {
            if (latest == null)
        ...
        public global::Pocos.lib2.MyClass CreateEmptyPoco()
        {
            return new global::Pocos.lib2.MyClass();
        }
        ...
        public AXSharp.Connector.Localizations.Translator Interpreter => global::lib2.PlcTranslator.Instance;
    }
}